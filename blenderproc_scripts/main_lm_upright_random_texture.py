...
#python rerun.py run examples/datasets/bop_challenge/main_lm_upright_random_texture.py ../datasets resources/cc_textures examples/datasets/bop_challenge/output --num_scenes=1000
...
for i in range(args.num_scenes):
    ...
    bproc.writer.write_bop(os.path.join(args.output_dir, 'bop_data'),
                           ...
                           dataset = 'lm_random_texture_no_bump_no_displacement',
                           depth_scale = 0.1,
                           depths = data["depth"],
                           colors = data["colors"], 
